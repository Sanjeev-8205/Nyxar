    ...
    if sentiment is None:
        ...
        with st.container(border=True):
            ...
            with col2:
                ...
                st.markdown(f"""<div style="text-align:right;"><div style="color:{confidence_color};font-size:3rem;font-weight:800;line-height:0.9; margin-top:0.5rem">{confidence:.0%}</div><div style="color:#9CA3AF;font-size:0.75rem;font-weight:700;letter-spacing:0.15em;text-transform:uppercase;margin-top:0.6rem;">Confidence</div></div>""", unsafe_allow_html=True)
